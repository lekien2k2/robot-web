 ...
 */
 ...
 var NAV2D = NAV2D || {
  ...
  NAV2D.Navigator = function(options) {
    ...
    poseListener.subscribe(function(base) {
      // update the robots position on the map
      console.log(base)
      robotMarker.x = base.pose.pose.position.x;
      robotMarker.y = -base.pose.pose.position.y;
      if (!initScaleSet) {
      ...
      // change the angle
      robotMarker.rotation = stage.rosQuaternionToGlobalTheta(base.pose.pose.orientation);
